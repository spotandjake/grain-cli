 ...
 */
export const optionsToFlags = (program: Command, options: any, positional: string[]) => {
  const flags: any[] = [];
 ...
 */
export const defaultWasmLocation = (file: string, options: { targetDir?: string; release?: boolean; } & Options): string => {
